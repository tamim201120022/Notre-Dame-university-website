<?php
  ...
  $sqlbsc= "SELECT tuition_id, programs, credit_hour, trimester_per_year, admission_fee, course_fee, semester_fee from cse_tuition_cost";
...
<head>
    ...
    <title>Undergraduate BSC Programs</title>
    ...
    <link rel="stylesheet" href="style/bsc.css">
    ...
    min-height: 100vh;
    width: 100%;
    background-image: linear-gradient(rgba(4,9,30,0.7),rgba(4,9,30,0.7)), url("images/marvin-meyer-SYTO3xs06fU-unsplash.jpg");
...
<body>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-secondary fixed-top">
          ...
          <div class="nav-body">
            <div class="text-box text-white">
                <h4>C O U R S E</h4>
                <h1>Bachelor of Science in Computer Science & Engineering (CSE)</h1>
                <p>The Department of Computer Science and Engineering (CSE) has been offering a 4-year undergraduate degree program <br> for Bachelor of Science (B.Sc.)  in Computer Science and Engineering (CSE) from 2015. This program is spread over twelve <br> trimesters with three trimesters per academic year. Admission is offered two times a year.</p>
            </div>               
          </div>
    </section>
    <!--Header end-->
    ...
    <section class="undergraduate-programs">
        <div class="card container mt-5" style="width: 70rem;">
            <h5 class="card-header text-muted" style="text-align: center;">BSC IN COMPUTER SCIENCE & ENGINEERING (CSE)</h5>
            <div class="card-body">
              <h5 class="card-title" style="text-align: center;">About the program</h5>
              <p class="card-text">The aim of this Department is to impart to the students up-to-date knowledge of different branches of the computer science and engineering field. However, it also helps the students develop transferable skills that are highly required by a wide range of employers. The undergraduate courses offered to the students have been designed considering the courses offered in various reputed universities, home and abroad, keeping in view the ever-increasing horizon of computer science & engineering.</p>
            </div>
          </div>
    </section>
    ...
    <div class="message">
        <div class="chairmen" style="max-width: 80%; display: block; margin: auto; margin-top: 100px;" data-aos="fade-in">
            <div class="card mb-3">
              <div class="row">

                <div class="col-md-4">
                  <img src="images/saiful_sir.jpg" class="img-fluid rounded-start vc-hover" alt="Fr.Patrick">
                  <h5>A. H. M. Saiful Islam <br> Chairman,  Department of CSE</h5>
                </div>
                ...
                <div class="col-md-8">
                  ...
                  <div class="card-body p-lg-5px">
                    ...
                    <p class="card-text" style="font-size: 16px;">The Department aims to maintain excellence in teaching, research, and service through a dense foundation of both the theory and practical works. The undergraduate and postgraduate programs in CSE are designed to produce skilled graduates to satisfy the growing demands in home and abroad. Our curriculums also give students the social, ethical, and liberal education needed to make significant contributions to society. Experienced and qualified faculty members are playing a great role to make a very student-friendly environment so that students get the best to learn and apply.</p>
                    <p class="card-text"><small class="text-muted">Associate Professor A. H. M. Saiful Islam</small></p>
    ...
    <h3 style="margin-top: 150px; text-align: center;">Tuition Fees & Cost</h3>
    <hr>
    <table class="container table  caption-top table-bordered border-dark mt-5" >              
