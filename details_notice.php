<?php
  ...
  $getId= $_GET['notice_id'];

  $sql= "SELECT notice_id, details, notice_img from notice_board WHERE notice_id=$getId";
                ...
                <ul class="navbar-nav styling">
                  ...
                  <li class="nav-item dropdown p-1 rounded btn-outline-primary">
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li><a class="dropdown-item dropdown-style text-black" href="#">Undergraduate Programs</a></li>
...
<!--Notice News Start-->
<div class="notice" style="margin-top: 90px;">
  <h1 style="text-align: center; background-color: yellow;">Notice Board</h1>
        
        <?php
            $data= mysqli_fetch_array($sql_query);
            $details_info= $data['details'];
            $image_info= $data['notice_img'];
        ?>
        <img class="n_image" src="images/<?php echo $image_info?>">
