          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <?php
                  ...
                  <input type="date" name="ndate"  class="form-control" value="<?= $notice['notice_date'];?>">
                  </div>

                  <div class="mb-3">
                  <label >Notice Details</label>
                  <input type="text" name="ndetails" value="<?= $notice['details'];?>" class="form-control">
                  </div>

                  <div class="mb-3">
                  <label >Notice Image</label>
                  <input type="text" name="nimg" value="<?= $notice['notice_img'];?>" class="form-control">
                  </div>
                    <div class="mb-3">
